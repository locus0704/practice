...
<tr><th>작성자</th>
<td><input type="text" name="noticewriter" readonly value="${ sessionScope.loginMember.userid }"></td></tr>
<tr><th>파일선택</th>
<td><input type="file" name="upfile"></td></tr>
<tr><th>내 용</th><td><textarea name="noticecontent" rows="5" cols="50"></textarea></td></tr>
<tr><th colspan="2">
